...
namespace {
	...
	SettingInfo settings[] = {
		...
		SETTING_STRING(blueprint_path, 0, NULL, "blueprint_dir", "data")
		SETTING_STRING(ai_path, 0, NULL, "ai_dir", "scripts")
		SETTING_STRING(zone_path, 0, NULL, "zone_dir", "data")
		SETTING_STRING(player_path, 0, NULL, "player_dir", "data")
		SETTING_STRING(help_path, 0, NULL, "help_dir", "data")
		...
		SETTING_STRING(html_path, 0, NULL, "misc_dir", "data/html")
